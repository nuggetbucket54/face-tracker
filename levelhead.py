...
while 1:
    ...
    try:
        ...
        #code to place all face landmarks (ignored for cleaner product)
        """
        ...
        #code to insert all of the points for the PNP formula (ignored for a cleaner end product)
        """
        ...
        #optional line to find the angle person is facing
